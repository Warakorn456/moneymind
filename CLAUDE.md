...
| ยังไม่ทำ | (1) **ตั้ง webhook URL ใน Omise dashboard** → Settings → Webhooks ชี้ไป `https://34-134-61-137.sslip.io/v1/webhook/omise` (ยังไม่ได้ตั้ง) (2) **ยังไม่มี UI ฝั่ง client** (ปุ่ม Subscribe ในเว็บ + Omise.js เก็บบัตร/แสดง QR PromptPay) — เขียน backend เสร็จอย่างเดียว |
