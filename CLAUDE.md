...
| ยังไม่ทำ | รอ Omise KYC ผ่าน → สลับ `OMISE_PUBLIC_KEY`/`OMISE_SECRET_KEY` เป็น live key + ตั้ง webhook ซ้ำใน live mode — ยังไม่ได้ end-to-end test จริงผ่าน UI (เขียนเสร็จ deploy แล้ว แต่ยังไม่มีใครกดสมัครจริงผ่านหน้าเว็บทดสอบ) |
